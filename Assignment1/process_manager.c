...
uint64_t
create_process(process_manager_t *pm, uint64_t pid, uint64_t psw, uint64_t reg0, uint64_t reg1, uint64_t reg2) {
    assert(pm != NULL);
...
uint64_t create_thread(process_manager_t *pm, uint64_t tid, uint64_t pid, uint64_t tsw, uint64_t reg0, uint64_t reg1,
                       uint64_t reg2) {
    assert(pm != NULL);
